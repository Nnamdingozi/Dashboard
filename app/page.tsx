...
//       {/* Main Section */}
//       <div className="flex flex-col items-center justify-center py-8 px-4 sm:py-16 sm:px-6 lg:px-12 space-y-8 h-auto">
//         {/* Animation Section */}
...
//         {/* Welcome Section */}
//         <div
//           className="text-center bg-gradient-to-br from-blue-500 via-gray-300 to-orange-200 w-full max-w-2xl p-6 sm:p-8 rounded-xl shadow-2xl"
//           data-aos="flip-left"
//           data-aos-easing="ease-out-cubic"
//           data-aos-duration="2000"
//         >
