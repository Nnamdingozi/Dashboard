    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-4 md:p-6">
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 md:gap-4 w-full sm:w-auto">
          <button
            onClick={handleEditProfile}
            className="bg-blue-600 text-white px-3 py-2 md:px-4 md:py-2 rounded-lg shadow-md hover:bg-blue-700 transition w-full sm:w-auto"
          >
            Edit Profile
          </button>
          <button
            onClick={handleLogout}
            className="border-2 border-red-700 text-red-700 px-3 py-2 md:px-4 md:py-2 rounded-lg shadow-md hover:bg-red-700 transition hover:text-white w-full sm:w-auto"
          >
            Logout
          </button>
        </div>
