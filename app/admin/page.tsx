...
const AdminDashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Container */}
      <div className="flex flex-col lg:flex-row gap-4 px-4 lg:px-8 mt-6">
        {/* Sidebar */}
        <div className="flex flex-col space-y-4 border-2 shadow-md w-full lg:w-1/4 mt-4 lg:mt-8 rounded-lg text-gray-600">
          <Link
            href="/admin/usersList"
            className="w-full border shadow-lg bg-blue-500 text-white rounded-md text-center py-3 hover:bg-blue-100 hover:text-blue-500"
          >
