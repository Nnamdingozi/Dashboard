  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        ...
        <input
          id="username"
          className={`h-10 w-full p-2 border rounded focus:outline-none text-black ${error.username ? 'border-red-600' : 'border-blue-400'}`}
          type="text"
          name="username"
          placeholder="Username"
          value={userInput.username}
      ...
      <div className="mb-4">
        ...
        <input
          id="email"
          className={`h-10 w-full p-2 border rounded focus:outline-none text-black ${error.email ? 'border-red-600' : 'border-blue-400'}`}
          type="email"
          name="email"
          placeholder="Email"
          value={userInput.email}
      ...
      <div className="mb-4">
        ...
        <input
          id="password"
          className={`h-10 w-full p-2 border rounded focus:outline-none text-gray-700 ${error.password ? 'border-red-600' : 'border-blue-400'}`}
          type="password"
          name="password"
          placeholder="Password"
          value={userInput.password}
      ...
      <div className="mb-4">
        <label htmlFor="privacyPolicy" className="flex items-center">
          <input
            ...
            required
            className="mr-2"
            aria-describedby="privacyPolicy-error"
          />
          Accept Privacy Policy
        </label>
        {error.privacyPolicy && <p id="privacyPolicy-error" className="text-red-600 text-sm">{error.privacyPolicy}</p>}
      </div>
      ...
      <div className="mb-4">
        ...
        <select
          id="role"
          className={`h-10 w-full p-2 border rounded focus:outline-none text-gray-700 ${error.role ? 'border-red-600' : 'border-blue-400'}`}
          name="role"
          value={userInput.role}
          onChange={handleInputChange}
          aria-invalid={!!error.role}
